...
export const DEFAULT_GRADUATION_MARKET_CAP_TESTNET =
  BigInt.fromI32(100000) // 100K
export const DEFAULT_GRADUATION_MARKET_CAP_MAINNET =
  BigInt.fromI32(2000000) // 2M