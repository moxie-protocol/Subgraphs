...
export const RAINBOW_ROUTER_MAINNET =
...
export const STAKING_CONTRACTS_MAINNET = new TypedMap<string, bool>()
STAKING_CONTRACTS_MAINNET.set(STAKING_MAINNET, true)

export const STAKING_TESTNET = "0x1d5c3fe067091dfdfe6dd31f62d0f9fa90509651"
export const STAKING_CONTRACTS_TESTNET = new TypedMap<string, bool>()
STAKING_CONTRACTS_TESTNET.set(STAKING_TESTNET, true)

export const WHITELISTED_CONTRACTS_TESTNET = new TypedMap<string, bool>()

export const DEFAULT_GRADUATION_MARKET_CAP_TESTNET = BigInt.fromI32(100000) // 100K
export const DEFAULT_GRADUATION_MARKET_CAP_MAINNET = BigInt.fromI32(25000000) // 25M
