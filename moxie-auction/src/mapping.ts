...
import { AggregateTransfer, AuctionDetail, ClearingPriceOrder, OrderTxn, Token, User } from "../generated/schema"
...
export function handleAuctionCleared(event: AuctionCleared): void {
  getOrCreateEasyAuction(event.address)
...
export function handleNewAuction(event: NewAuction): void {
  ...
  auctionDetails.initialization = event.transaction.hash.toHexString()
