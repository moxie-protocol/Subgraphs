...
import { convertToPricePoint, updateAuctionStats, getOrderEntityId, loadUser, loadAuctionDetail, loadOrder, getTokenDetails, decreaseTotalBiddingValueAndOrdersCount, increaseTotalBiddingValueAndOrdersCount, getOrCreateBlockInfo, loadSummary, getTxEntityId, getEncodedOrderId, createOrderTxn, getClaimedAmounts, updateOrderCounter, convertHexStringToBigInt, isBlacklistedAuction, isBlacklistedSubjectTokenAddress } from "./utils"
...
export function handleNewAuction(event: NewAuction): void {
  ...
  if (isBlacklistedSubjectTokenAddress(event.params._auctioningToken)) {
    return
  }
