import { Sync, Transfer } from "../generated/UniswapV2Pair/UniswapV2Pair"
import {
  Sync as Sync2,
  Transfer as Transfer2,
} from "../generated/AerodromePair/AerodromePair"
import { Deposit, Withdraw } from "../generated/AerodromeGauge/AerodromeGauge"
import {
...
import {
  Mint,
  Burn,
  SetGaugeAndPositionManagerCall,
  Swap,
  Collect,
  CollectFees,
  Flash,
...
export function handleMint(event: Mint): void {
  ...
  let txEntity = new V3NftMintViaTransfer(
    event.transaction.hash
      .toHexString()
      .concat("-")
...
//   entity.createdAtBlockNumber = call.block.number
//   entity.save()
