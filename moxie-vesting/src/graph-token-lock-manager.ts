...
export function handleFunctionCallAuth(event: FunctionCallAuth): void {
  ...
  entity.sigHash = event.params.sigHash
  ...
  //
  // - contract.authFnCalls(...)
  // - contract.getAuthFunctionCallTarget(...)
  // - contract.getDeploymentAddress(...)
  // - contract.getTokenDestinations(...)
  // - contract.isAuthFunctionCall(...)
  // - contract.isTokenDestination(...)
  // - contract.masterCopy(...)
  // - contract.owner(...)
  // - contract.token(...)
}
